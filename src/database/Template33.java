...
public class Template33 
{
    ...
    public Template33(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 8)
            {
                ...
                if(colData.get(i + 0) == null)//
                {
                    ...
                    stmt.setInt(12, java.sql.Types.VARCHAR);//pricelevel
                ...
                else
                {
                    ...
                    stmt.setLong(11, Long.parseLong(colData.get(i + 4).toString()));
                    stmt.setString(12, colData.get(i + 5).toString());
        ...
        {
            System.out.println("Class database.Template33 error: " + ex);
        }
        finally
        {
            try 
