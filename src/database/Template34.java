...
public class Template34 
{
    ...
    public Template34(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 7)
            {
                ...
                if(colData.get(i + 0) == null)//
                {
                    ...
                    stmt.setDouble(8, java.sql.Types.DECIMAL);//price
                ...
                else
                {
                    ...
                    stmt.setDouble(8, Double.parseDouble(colData.get(i + 1).toString()));
                    stmt.setDouble(9, Double.parseDouble(colData.get(i + 2).toString()));
        ...
        {
            System.out.println("Class database.Template34 error: " + ex);
        }
        finally
        {
            try 
