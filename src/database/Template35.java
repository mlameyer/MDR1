...
public class Template35 
{
    ...
    public Template35(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 6)
            {
        ...
        {
            System.out.println("Class database.Template35 error: " + ex);
        }
        finally
        {
            try 
