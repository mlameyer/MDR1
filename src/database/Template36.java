...
public class Template36 
{
    ...
    public Template36(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 9)
            {
                ...
                if(colData.get(i + 0) == null)//
                {
                    ...
                    stmt.setInt(15, java.sql.Types.INTEGER);//entrytype
                }
                else
                {
                    ...
                    stmt.setString(15, colData.get(i + 8).toString());
                }
        ...
        {
            System.out.println("Class database.Template36 error: " + ex);
        }
        finally
        {
            try 
