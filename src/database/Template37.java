...
public class Template37 
{
    ...
    public Template37(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 5)
            {
                ...
                if(colData.get(i + 0) == null)//
                {
                    ...
                    stmt.setInt(11, java.sql.Types.VARCHAR);//#oforders
                }
                else
                {
                    ...
                    stmt.setString(11, colData.get(i + 4).toString());
                }
        ...
        {
            System.out.println("Class database.Template37 error: " + ex);
        }
        finally
        {
            try 
