...
public class Template38 
{
    ...
    public Template38(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 15; i < colData.size(); i = i + 8)
            {
                ...
                stmt.setInt(5, Integer.parseInt(colData.get(4).toString()));
                stmt.setInt(6, Integer.parseInt(colData.get(5).toString()));
                stmt.setInt(7, Integer.parseInt(colData.get(6).toString()));
                stmt.setInt(8, Integer.parseInt(colData.get(7).toString()));
                stmt.setInt(9, Integer.parseInt(colData.get(8).toString()));
                stmt.setInt(10, Integer.parseInt(colData.get(9).toString()));
                stmt.setInt(11, Integer.parseInt(colData.get(10).toString()));
                stmt.setInt(12, Integer.parseInt(colData.get(11).toString()));
                stmt.setDouble(13, Double.parseDouble(colData.get(12).toString()));
                stmt.setDouble(14, Double.parseDouble(colData.get(13).toString()));
                stmt.setDouble(15, Double.parseDouble(colData.get(14).toString()));
                ...
                else
                {
                    ...
                    stmt.setString(13, colData.get(i + 6).toString());
