...
public class Template4
{
    ...
    public Template4(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 3)
            {
                ...
                {
                    stmt.setInt(7, java.sql.Types.INTEGER);
                    stmt.setInt(8, java.sql.Types.INTEGER);
                    stmt.setInt(9, java.sql.Types.VARCHAR);
                }
                else
                {
        ...
        {
            System.out.println("Class database.Template4 error: " + ex);
        }
        finally
        {
            try 
