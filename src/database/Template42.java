...
public class Template42 
{
    ...
    public Template42(String tableName, ArrayList colData, Properties prop, boolean option) 
    {
    ...
    public void execute() 
    {
        ...
        try 
        {
            ...
            for(int i = 6; i < colData.size(); i = i + 8)
            {
                ...
                if(colData.get(i + 0) == null)//
                {
                    ...
                    stmt.setInt(14, java.sql.Types.VARCHAR);//entrytype
                }
                else
                {
                    ...
                    stmt.setString(14, colData.get(i + 7).toString());
                }
        ...
        {
            System.out.println("Class database.Template42 error: " + ex);
        }
        finally
        {
            try 
