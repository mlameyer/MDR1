...
class Message15Decoder 
{
    ...
    public Message15Decoder(byte[] message, int bufferOffset, int actingBlockLength, int actingVersion, boolean option) 
    {
    ...
    public DatabaseObject decode() 
    {
       ...
       colData.add(marketData.heartBtInt());
       
       if(option)
       {
           tableName = "INSERT INTO cme_market_datafeed.adminlogin15_options " 
            + "(Seq_Num_34,Sending_Time_52,TempId,MsgType_35,HeartBtInt_108) "
            + "VALUES (?,?,?,?,?)";
       }
       else
       {
           tableName = "INSERT INTO cme_market_datafeed.adminlogin15 " 
            + "(Seq_Num_34,Sending_Time_52,TempId,MsgType_35,HeartBtInt_108) "
            + "VALUES (?,?,?,?,?)";
       }
