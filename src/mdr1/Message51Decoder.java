...
import mktdata.MDIncrementalRefreshSessionStatistics51;
 ...
 */
class Message51Decoder 
{
    private final int template = 35;
    private final boolean option;
    private String tableName;
    private final MDIncrementalRefreshSessionStatistics51 marketData = new MDIncrementalRefreshSessionStatistics51();
    ...
    public Message51Decoder(byte[] message, int bufferOffset, int actingBlockLength, int actingVersion, boolean option) 
    {
    ...
    public DatabaseObject decode() 
    {
       ...
       for(final MDIncrementalRefreshSessionStatistics51.NoMDEntries noMDEntries : marketData.noMDEntries())
       {
